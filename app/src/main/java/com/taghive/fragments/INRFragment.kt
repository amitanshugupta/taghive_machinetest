...
class INRFragment(
    ...
    companion object {
        fun newInstance(tickersList: ArrayList<TickersModel>): INRFragment {
            return INRFragment(tickersList)
        }
    }
    ...
    private fun initListeners() {
        swipeRefreshLayout.setOnRefreshListener {
            (requireActivity() as HomeActivity).getTickersList(1)
        }
    }
