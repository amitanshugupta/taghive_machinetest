...
import com.taghive.adapters.TickersAdapter
...
class USDTFragment(
    ...
    companion object {
        fun newInstance(tickersList: ArrayList<TickersModel>): USDTFragment {
            return USDTFragment(tickersList)
        }
    }
    ...
    private fun initListeners() {
        swipeRefreshLayout.setOnRefreshListener {
            (requireActivity() as HomeActivity).getTickersList(0)
        }
    }
